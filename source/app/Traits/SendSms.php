...
trait SendSms {
    public function ordersuccessfull($cart_id,$prod_name,$price2,$delivery_date,$time_slot,$user_phone) {
        ...
        $getInvitationMsg = "Dear Customer, \nYour Order with order #".$cart_id." for " .$currency->currency_sign." ".$price2. " is successfully placed. Your order has been scheduled to be delivered on ".$delivery_date1." between ".$time_slot.". \n\nThank you, \nTeam rucamart";
        ...
        if($smsby->msg91==1){       
         $sms_api_key=  DB::table('msg91')
                      ...
                      ->first();
                        ...
                        $authKey = $getAuthKey;
                        $senderId = $getSenderId;
                        $message1 = urlencode($getInvitationMsg);
                        $route = "4";
                        $postData = array(
                            'authkey' => $authKey,
    ...
    if($smsby->status==1){       
     ...
     public function delcomsms($cart_id, $prod_name, $price2,$currency,$user_phone) {
        ...
        $stv= $st." products";  
         ...
         $getInvitationMsg = "Dear Customer, \nYour Order with order #".$cart_id." for " .$currency->currency_sign." ".$price2." is delivered successfully. \nThank you for shopping with us! \n\nThank you, Team rucamart";
        ...
        if($smsby->msg91==1){       
         $sms_api_key=  DB::table('msg91')
                      ...
                      ->first();
                        ...
                        $postData = array(
                            'authkey' => $authKey,
                            'mobiles' => "91".$user_phone,
                            'message' => $message1,
                            'sender' => $sender_id,
                            'route' => $route,
                            'DLT_TE_ID'=>1307164648987824313
                        );
     ...
     public function welmsg($user_name,$user_phone,$user_email) {
        $countrycode =DB::table('country_code')
         ...
         $logo = DB::table('tbl_web_setting')
             ->first();
       $app_name = $logo->name;             
        $getInvitationMsg = "Dear Customer,\n Welcome to rucamart! We are happy to have you here. You can now order products for your business anytime, anywhere with convenience and ease. Happy shopping! \n\nThank you, Team rucamart" ;
