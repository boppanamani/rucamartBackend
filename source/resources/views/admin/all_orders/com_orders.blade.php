    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{$ords->boy_name}}<p style="font-size:14px">({{$ords->boy_phone}})</p></td>
             ...
             <td>{{$ords->delivery_date}}<p style="font-size:14px">({{$ords->time_slot}})</p></td>
            ...
            @endif
             <td>
                  @if($ords->payment_method == "COD" || $ords->payment_method == "cod" || $ords->payment_method == "Cod" || $ords->payment_method == "COD") <b style="color:red"> @else <b style="color:green"> @endif {{$ords->payment_method}}</b></td>
                  
             <td><p><span class="dot" style="color:red"></span>@if($ords->commission > 0) <b style="color:red"> {{$ords->commission}} @else <b style="color:green"> 0 @endif</b></p></td>      
