...
<table id="datatableDefault" class="table table-striped text-nowrap w-100">
    <thead class="thead-light">
        <tr>
            ...
            <th>{{ __('keywords.Cancel Order')}}</th>
        </tr>
    </thead>
    <tbody>
           @if(count($ord)>0)
        ...
        <tr>
            ...
            <td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal2{{$ords->cart_id}}">Cancel</button></td>
        </tr>
          @php $i++; @endphp
                 @endforeach
                  @else
                      ...
                      <div class="col-md-6" align="center">
                        ...
                        <div class="form-group">
                           <label>{{ __('keywords.Send Rejection Reason to User')}}</label>    
        		     	   <textarea name="cause" row="5" class="form-control" required></textarea>
        			    </div>
